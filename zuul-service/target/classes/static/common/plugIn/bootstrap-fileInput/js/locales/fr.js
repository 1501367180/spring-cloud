...
(function ($) {
    ...
    $.fn.fileinputLocales['fr'] = {
        ...
        msgImageWidthSmall: 'La largeur de l\'images "{name}" doit être d\'au moins {size} px.',
        msgImageHeightSmall: 'La hauteur de l\'images "{name}" doit être d\'au moins {size} px.',
        msgImageWidthLarge: 'La largeur de l\'images "{name}" ne peut pas dépasser {size} px.',
        msgImageHeightLarge: 'La hauteur de l\'images "{name}" ne peut pas dépasser {size} px.',
        msgImageResizeError: "Impossible d'obtenir les dimensions de l'images à redimensionner.",
        msgImageResizeException: "Erreur lors du redimensionnement de l'images.<pre>{errors}</pre>",
