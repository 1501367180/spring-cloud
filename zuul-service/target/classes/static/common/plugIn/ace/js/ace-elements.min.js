        ...
        g.error = {
            ...
            if (d && 0 != d.length) {
                ...
                for (var g = 0; g < d.length; g++) {
                    ...
                    var l = {
                            file: "fa fa-file",
                            image: "fa fa-picture-o file-images",
                    ...
                    i = function (b, f) {
                        ...
                        if (j) {
                            ...
                            "small" == c.settings.thumbnail ? m = n = parseInt(Math.max(m, n)) : d.addClass("large"), a(b).css({
                                ...
                                src: "data:images/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg=="
                            }).show()
                        }
                        e.resolve()
                    },
